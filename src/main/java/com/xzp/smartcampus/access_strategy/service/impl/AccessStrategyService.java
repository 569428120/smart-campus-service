...
public class AccessStrategyService extends IsolationBaseService<AccessStrategyMapper, AccessStrategyModel>
     ...
     * @return
     */
    public PageResult<AccessStrategyDetailModel> findStrategyByCondition(
        ...
        List<AccessStrategyModel> strategyModels=strategyModePageResult.getData();
        ...
        return new PageResult<>(strategyModePageResult.getTotal(),strategyDetailModels);
    }
